	...
	<div class="container content">
		...
		<div class="action">
			...
			<form method="post" action="<?php echo BASE_URL . 'admin/users.php'; ?>" >
				...
				<input type="password" name="passwordConfirmation" placeholder="Ponovite lozinku">
				<select name="role">
					<option value="" selected disabled>Uloga</option>
				...
				<?php if ($isEditingUser === true): ?> 
					<button type="submit" class="btn" name="update_admin">IZMJENI</button>
				<?php else: ?>
					<button type="submit" class="btn" name="create_admin">DODAJ KORISNIKA</button>
				<?php endif ?>
			</form>
		</div>
		<!-- // Middle form - to create and edit -->
